...
public class MultiPartStack extends HurlStack {
    ...
    public HttpResponse performRequest(Request<?> request,
        ...
        if(!(request instanceof MultiPartRequest)) {
            ...
            return performMultiPartRequest((MultiPartStringRequest)request, additionalHeaders);
        }
    }
    ...
    public HttpResponse performMultiPartRequest(MultiPartStringRequest request,
                                                Map<String, String> additionalHeaders)  throws IOException, AuthFailureError {
    ...
    private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
        ...
        httpRequest.setHeader(HEADER_CONTENT_TYPE, entity.getContentType().getValue());
        //httpRequest.setHeader("Connection", "keep-alive");
        //httpRequest.setHeader("Content-Length", "" + entity.getContentLength());
